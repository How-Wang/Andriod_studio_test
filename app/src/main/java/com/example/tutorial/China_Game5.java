...
public class China_Game5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_china_game5);
    ...
    public void CorrectClicked(View v){
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                startActivity(new Intent(China_Game5.this, LeaderBoard.class));
